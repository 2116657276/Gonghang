...
<style lang="scss">@use '../../styles/tokens' as *;.back{position:absolute;z-index:4;top:calc(34px + env(safe-area-inset-top));right:28px;width:64px;height:64px;color:$brand-deep;background:rgba(255,255,255,.78);border-radius:50%;font-size:44px}.card-title,.item-title{font-size:34px;font-weight:730;line-height:1.4}.assessment,.missing,.boundary{margin-top:24px}.assessment{padding:20px;background:#EEF7FB;border-radius:20px}.draft-list{display:grid;gap:20px;margin-top:24px}.draft-list .section-card{border-left:7px solid $info}.suggestion{display:block;margin-top:18px;padding:16px 18px;color:$text-secondary;background:$soft-surface;border-radius:18px;font-size:27px;line-height:1.6}.adopt,.action{width:100%;min-height:96px;margin-top:22px;font-size:28px}.adopt-link{min-height:72px;margin-top:10px;font-size:27px}.draft-actions{display:grid;gap:16px;margin-top:28px}.action--discard{color:$text-secondary}.period-picker{width:100%;min-height:96px;padding:20px;margin-top:20px;background:$soft-surface;border-radius:20px;font-size:28px;line-height:1.5}.boundary{font-size:28px;line-height:1.65}</style>
