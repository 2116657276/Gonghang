...
.back{position:absolute;z-index:4;top:calc(34px + env(safe-area-inset-top));right:28px;width:64px;height:64px;color:$brand-deep;background:rgba(255,255,255,.72);border-radius:50%;font-size:44px}.result-card{overflow:hidden;background:linear-gradient(145deg,#fff,#F4F8F6)}.result-card--needs_adjustment,.result-card--blocked{background:linear-gradient(145deg,#fff,#FFF8EE)}.result-card--unknown{background:linear-gradient(145deg,#fff,#F4F6F8)}.result-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.eyebrow,.result-title,.result-detail,.result-number text,.result-number b{display:block}.eyebrow{color:$text-secondary;font-size:20px}.result-title{margin-top:7px;font-size:31px;font-weight:760;line-height:1.3}.result-detail{margin-top:18px;color:$text-secondary;font-size:22px;line-height:1.65}.result-number{margin-top:24px;padding-top:20px;border-top:1px solid $border}.result-number text{color:$text-secondary;font-size:20px}.result-number b{margin-top:8px;font-size:42px;overflow-wrap:anywhere}.date-list{margin-top:18px;padding:18px;background:$soft-surface;border-radius:15px}.date-list text{display:block;font-size:21px}.date-list text+text{margin-top:7px;color:$text-secondary;line-height:1.5}.breakdown-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.breakdown-grid .section-card{min-width:0;padding:22px}.breakdown-grid text,.breakdown-grid b{display:block}.breakdown-grid text{color:$text-secondary;font-size:20px}.breakdown-grid b{margin-top:9px;font-size:27px;overflow-wrap:anywhere}.reason-list{display:grid;gap:16px}.reason-list view{display:flex;align-items:flex-start;gap:12px}.reason-list view>text:last-child{flex:1;font-size:22px;line-height:1.55}.reason-dot{flex:0 0 12px;width:12px;height:12px;margin-top:10px;background:$warning;border-radius:50%}.page-actions{display:grid;gap:12px;margin-top:24px}.page-actions button{width:100%}.boundary{margin-top:18px}
@media screen and (max-width:360px){.result-heading{display:grid}.result-heading .status-badge{justify-self:start}.result-title{font-size:28px}.result-number b{font-size:36px}.breakdown-grid{grid-template-columns:1fr}}
</style>
