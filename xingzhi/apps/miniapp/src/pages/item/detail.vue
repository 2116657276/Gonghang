...
<template>
  <PageShell :title="item?.title ?? '计划详情'" subtitle="一个计划的状态、影响与下一步" compact>
    ...
    <template v-else>
      ...
      <template v-if="latestIntent||canFindOffers"><SectionHeader title="购买与订单" />
...
.back{position:absolute;z-index:4;top:calc(34px + env(safe-area-inset-top));right:28px;width:64px;height:64px;color:$brand-deep;background:rgba(255,255,255,.78);border-radius:50%;font-size:44px}.retry{margin:24px auto 0}.summary-card{background:linear-gradient(145deg,$surface-tint,#fff)}.summary-heading{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:start;gap:18px}.plan-icon{display:flex;width:68px;height:68px;align-items:center;justify-content:center;color:$brand-primary;background:#fff;border-radius:20px;font-size:28px;font-weight:740}.eyebrow,.plan-title,.plan-amount,.summary-meta text,.purchase-title,.purchase-meta{display:block}.eyebrow{color:$text-secondary;font-size:26px}.plan-title{margin-top:8px;font-size:38px;font-weight:760;line-height:1.35;overflow-wrap:anywhere}.plan-amount{margin-top:32px;font-size:58px;font-weight:800;overflow-wrap:anywhere}.summary-meta{display:flex;flex-wrap:wrap;gap:12px 20px;margin-top:16px;color:$text-secondary;font-size:28px}.impact-card{cursor:pointer}.impact-arrow{color:$brand-primary;font-size:46px}.impact-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:24px 0 10px}.impact-grid view{min-width:0;padding:22px;background:$soft-surface;border-radius:20px}.impact-grid text,.impact-grid b{display:block}.impact-grid text{color:$text-secondary;font-size:26px}.impact-grid b{margin-top:10px;font-size:34px;overflow-wrap:anywhere}.purchase-title{font-size:32px;font-weight:720;overflow-wrap:anywhere}.purchase-meta{margin-top:9px;color:$text-secondary;font-size:26px;line-height:1.55}.full{width:100%;margin-top:20px}.offers-button{margin:22px auto 0}.action-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.action-grid button{width:100%}.action-wide{grid-column:1/-1}.boundary{margin-top:24px;font-size:28px;line-height:1.6}.timeline-card{padding-top:14px;padding-bottom:14px}.timeline-row{display:grid;grid-template-columns:auto minmax(0,1fr);gap:18px;align-items:start;padding:20px 0}.timeline-row+.timeline-row{border-top:1px solid $border}.timeline-dot{box-sizing:content-box;width:14px;height:14px;margin-top:10px;background:$brand-primary;border:4px solid $surface-tint;border-radius:50%}.timeline-row text{display:block;font-size:28px}.timeline-row text+text{margin-top:7px;color:$text-secondary;font-size:25px}
@media screen and (max-width:360px){.summary-heading{grid-template-columns:auto minmax(0,1fr)}.summary-heading .status-badge{grid-column:2;justify-self:start}.plan-amount{font-size:50px}.impact-grid,.action-grid{grid-template-columns:1fr}.action-wide{grid-column:auto}}
</style>
