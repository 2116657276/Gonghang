...
.plan-item__top{display:flex;align-items:flex-start;gap:16px}.plan-item__icon{display:flex;flex:0 0 54px;height:54px;align-items:center;justify-content:center;color:$brand-primary;background:$surface-tint;border-radius:16px;font-size:22px;font-weight:700}
.plan-item__copy{flex:1;min-width:0}.plan-item__title,.plan-item__date{display:block}.plan-item__title{overflow:hidden;font-size:27px;font-weight:680;text-overflow:ellipsis;white-space:nowrap}.plan-item__date{margin-top:7px;color:$text-secondary;font-size:21px}
.plan-item__amount{flex:0 0 auto;font-size:27px;font-weight:700;white-space:nowrap}.plan-item__status{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-top:22px;padding-top:18px;border-top:1px solid $border}.plan-item__status>view{flex:1;min-width:0}.plan-item__support{display:block;margin-top:9px;color:$text-secondary;font-size:21px;line-height:1.4}.plan-item__status .link-button{flex:0 0 auto;white-space:nowrap}
@media screen and (max-width:360px){.plan-item{padding:22px}.plan-item__top{display:grid;grid-template-columns:48px minmax(0,1fr);gap:14px}.plan-item__icon{width:48px;height:48px}.plan-item__amount{grid-column:2;margin-top:2px;font-size:25px}.plan-item__title{white-space:normal}.plan-item__status{align-items:flex-start}.plan-item__status .link-button{padding-top:3px;font-size:22px}}
</style>
