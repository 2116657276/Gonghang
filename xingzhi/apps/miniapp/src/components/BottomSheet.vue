...
@media screen and (max-width:360px){.sheet{padding:12px 20px calc(20px + env(safe-area-inset-bottom));border-radius:24px 24px 0 0}.sheet__handle{margin-bottom:18px}.sheet__title{font-size:28px}.sheet__description{font-size:20px}.sheet__body{max-height:48vh;margin-top:20px}.sheet__actions{display:grid;gap:10px;margin-top:20px}.sheet__actions button{width:100%}}
</style>
